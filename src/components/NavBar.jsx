                    ...
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <div className="dropdown-menu text-dark fs-1" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                {/* Local Treks with Sandhan Valley */}
                                <div className="dropdown-submenu">
                                    <Link className="dropdown-item dropdown-toggle" to="#">Local Treks</Link>
                                    <div className="dropdown-menu">
                                        <Link className="dropdown-item" to="/sandhanvalley">Sandhan Valley</Link>
                                        <Link className="dropdown-item" to="/cats?cat=Local Treks">View All Local Treks</Link>
                                    </div>
                                </div>
